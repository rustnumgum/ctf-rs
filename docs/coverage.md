...
| 4 | sparse_formats/*; contraction/sp*; summation/spr*; tensor sparse paths | sparse; sparse_formats; contraction; summation | speye, sptensor_sum, sparse_mp3, custom sparse endomorphisms | local sparse kernels plus distributed virtual-block sparse storage, indexed I/O, redistribution, slice/permutation and stored transforms implemented; distributed sparse/mixed contractions and full upstream sparse tests pending |
