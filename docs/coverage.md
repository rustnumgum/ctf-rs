...
| 4 | symmetry/*; symmetric sequential kernels | symmetry; symmetric_distribution; symmetric_tensor | NS/SY/AS/SH compressed layouts, mixed symmetry and repeated indices | distributed compressed layout, canonical I/O, local transforms and same-symmetry redistribution implemented; symmetric summation/contractions and symmetry conversion pending |
