...
| 4 | sparse_formats/*; contraction/sp*; summation/spr*; tensor sparse paths | sparse; sparse_sum; sparse_formats; contraction; summation | speye, sptensor_sum, sparse_mp3, custom sparse endomorphisms | distributed sparse storage/I/O/views plus sparse-sparse and mixed sparse/dense indexed sums implemented; optimized sparse sum communication, distributed contractions and full upstream sparse suite pending |
