...
| 4 | symmetry/*; symmetric sequential kernels | symmetry; symmetric_distribution; symmetric_tensor | NS/SY/AS/SH compressed layouts, mixed symmetry and repeated indices | distributed compressed layout, canonical I/O, local transforms, redistribution and canonical-domain repack implemented; symmetry-aware summation/contractions pending |
