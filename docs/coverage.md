...
| 5 | interface/multilinear | multilinear; multilinear_factor; sparse_multilinear; solve_factor; tensor_svd; reshape | TTTP, MTTKRP, Solve_Factor, tensor SVD | generic semiring dense/sparse TTTP with mode-fiber factor broadcast and source fiber-grouped MTTKRP, f64 distributed weighted Solve_Factor, four-type indexed tensor SVD and key-based reshape implemented; optimized reshape communication, other multilinear scalar kernels and automatic memory selection pending |
