...
| 5 | interface/multilinear | multilinear | TTTP, MTTKRP, Solve_Factor, tensor SVD | dense f64 TTTP with explicit auxiliary blocking and vector/aux-first MTTKRP with fiber broadcasts/reductions implemented; TTTP optimized broadcast, automatic memory selection, sparse paths and remaining multilinear routines pending |
