...
| 4 | interface/{functions,fun_term}; transforms in tensor | algebra; tensor; sparse_functions; sparse_function_kernel | univar_function, bivar_function, bivar_transform, endomorphism* | local dense/stored transforms, typed sparse maps, subset-index accumulators and distributed CSR custom sparse/dense or sparse/sparse-to-dense products implemented; full function dispatch, other kernels and high-order custom contractions pending |
