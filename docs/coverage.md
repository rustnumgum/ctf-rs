...
| 2 | scaling/*; summation/*; redistribution/{slice,nosym_transp} | scaling; summation; redistribution | diag_sym, diag_ctr, scalar, permutations and slices | dense scale/strip, packed indexed scaling, offset slice, axis transpose and indexed endomorphisms implemented; remaining summation/redistribution paths pending |
