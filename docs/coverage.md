...
| 5 | interface/schedule; tensor persistence/graph I/O; shared diagnostics | schedule; tensor; shared; sparse_text; ffi/mpi_io | schedules, checkpoint, graph input, diagnostics | four-type coordinate MPI-IO, scheduling, named timer accumulation and process-global flop snapshots implemented; remaining persistence/driver coverage pending |
