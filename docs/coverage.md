...
| 5 | interface/multilinear | multilinear; sparse_multilinear; solve_factor; tensor_svd; reshape | TTTP, MTTKRP, Solve_Factor, tensor SVD | dense/sparse f64 TTTP, MTTKRP and distributed weighted Gram-system Solve_Factor, indexed tensor SVD and key-based reshape implemented; optimized dense TTTP/reshape communication, additional scalar kernels and automatic memory selection pending |
